...
namespace wStoreWebApi.Areas.Classic.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        // GET: Classic/Authors/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Classic/Authors/Create
